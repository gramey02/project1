...
def reverse_transcribe(seq: str) -> str:
    ...
    reverseDict = {"A":"U", "C":"G", "T":"U", "G":"C"} #create a dictionary to reverse letters in the transcript. A to U, C to G, T to U, and G to C (following what was in the README file)
